...
final class Banwave{
	...
	/** @var bool */
	private mixed $issued = false;
	/** @var bool */
	private mixed $completed = false;
	/** @var string */
	private string $path = "";
	/** @var int */
	private int $id;
	...
	public function toJson() : string{
		return json_encode(["issued" => $this->issued, "completed" => $this->completed, "players" => $this->players, "banned_players" => $this->bannedPlayers], JSON_THROW_ON_ERROR);
	}
