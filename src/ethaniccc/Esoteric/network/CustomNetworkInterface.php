...
class CustomNetworkInterface extends RakLibInterface implements ServerEventListener, AdvancedNetworkInterface{
	/**
	...
	private PacketBroadcaster|StandardPacketBroadcaster $broadcaster;
